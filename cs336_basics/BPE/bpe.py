...
def train_bpe(
    ...
    logger.info(f"BPE Training took {(end_train_time - start_train_time)/60:.3f} Minutes")
    logger.info(f"Memory used during training {(end_memory - start_memory)/1e9:.3f} GB")
